/**
 * RGBELoader - Lädt HDR Bilder im Radiance RGBE Format
 * Basiert auf: https://github.com/mrdoob/three.js/blob/dev/examples/jsm/loaders/RGBELoader.js
 */
	...
	class RGBELoader extends THREE.DataTextureLoader {
		...
		parse( buffer ) {
			...
			const
				...
				rgbe_error = function ( rgbe_error_code, msg ) {
					...
					switch ( rgbe_error_code ) {
						...
						case rgbe_memory_error:
							console.error( 'THREE.RGBELoader: Memory Error: ' + ( msg || '' ) );
							break;
				...
				/* number of floats per pixel, use 4 since stored in rgba image */
				//RGBE_DATA_SIZE = 4,
